...
class PeruLocations {
  ...
  static const Map<String, List<String>> districts = {
    ...
    // Catálogo OFICIAL completo de Junín (mismo contenido y orden que el
    // seed del backend — mantener en sincronía).
    'Huancayo': [
      'Huancayo',
      'El Tambo',
      'Chilca',
    ...
    // Chanchamayo) pero se conserva: hay usuarios registrados en él.
    'Chanchamayo': [
      'La Merced',
      'Chanchamayo',
      'San Ramón',
  ...
  static List<String> districtsOf(String province) => districts[province] ?? [];

  /// Verifica si un departamento tiene provincias con distritos cargados
  static bool hasDistricts(String province) => districts.containsKey(province);
