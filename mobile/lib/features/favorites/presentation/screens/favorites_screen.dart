  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: c.bg,
        elevation: 0,
        title: Text('Mis favoritos', style: TextStyle(color: c.textPrimary, fontWeight: FontWeight.bold)),
      ),
      body: userId == null
          ? _GuestBody(
              ...
              message: 'Regístrate para guardar tus proveedores favoritos y acceder a más funciones.',
            )
                ...
                return RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final provider = favProv.favorites[index].copyWith(isFavorite: true);
                      return ServiceCard(
                        provider: provider,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.favorite_border_rounded, color: AppColors.favorite, size: 40),
            ),
