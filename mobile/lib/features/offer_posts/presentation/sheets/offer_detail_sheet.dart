...
class OfferDetailSheet extends StatelessWidget {
  ...
  Future<void> _openProviderCard(BuildContext context) async {
    ...
    final result = await ProvidersRepository().getProviderDetail(
      offer.provider.id,
    );
    ...
    if (result.isSuccess) {
      ...
      messenger.showSnackBar(
        const SnackBar(
          content: Text('No se pudo abrir el perfil del proveedor'),
        ),
      );
    }
  }
...
class _OwnOfferActions extends StatelessWidget {
  ...
  Future<void> _confirmDelete(
    ...
    PublicOffersProvider offersProv,
  ) async {
    final c = context.colors;
    ...
    try {
      ...
      messenger.showSnackBar(const SnackBar(content: Text('Oferta eliminada')));
    } catch (e) {
      messenger.showSnackBar(
