...
// Leer key.properties si existe (dev local y CI/CD)
...
android {
    namespace = "com.oficioapp.mobile"
    ...
    defaultConfig {
        applicationId = "com.oficioapp.mobile"
    ...
    signingConfigs {
        create("release") {
            ...
            storeFile    = file(keyProperties.getProperty("storeFile") ?: System.getenv("STORE_FILE") ?: "../app/release-key.jks")
