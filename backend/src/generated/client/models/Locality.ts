...
export type LocalityWhereUniqueInput = Prisma.AtLeast<
  {
    ...
    province?: Prisma.StringNullableFilter<'Locality'> | string | null;
    source?:
      | Prisma.EnumLocalitySourceFilter<'Locality'>
...
export type LocalityScalarWhereWithAggregatesInput = {
  ...
  district?:
    | Prisma.StringNullableWithAggregatesFilter<'Locality'>
    | string
    | null;
  province?:
    | Prisma.StringNullableWithAggregatesFilter<'Locality'>
    ...
    | null;
  source?:
    | Prisma.EnumLocalitySourceWithAggregatesFilter<'Locality'>
    | $Enums.LocalitySource;
  department_norm?:
    | Prisma.StringNullableWithAggregatesFilter<'Locality'>
    | string
...
export type LocalityUpdateInput = {
  ...
  source?:
    | Prisma.EnumLocalitySourceFieldUpdateOperationsInput
    | $Enums.LocalitySource;
  department_norm?:
...
export type LocalityCreateNestedOneWithoutProvidersInput = {
  create?: Prisma.XOR<
    Prisma.LocalityCreateWithoutProvidersInput,
    Prisma.LocalityUncheckedCreateWithoutProvidersInput
  >;
...
export type LocalityUpdateOneRequiredWithoutProvidersNestedInput = {
  ...
  update?: Prisma.XOR<
    Prisma.XOR<
      Prisma.LocalityUpdateToOneWithWhereWithoutProvidersInput,
      Prisma.LocalityUpdateWithoutProvidersInput
    >,
    Prisma.LocalityUncheckedUpdateWithoutProvidersInput
  >;
};
 ...
 * LocalityCountOutputType without action
 */
export type LocalityCountOutputTypeCountProvidersArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
...
> extends Prisma.PrismaPromise<T> {
  ...
  providers<T extends Prisma.Locality$providersArgs<ExtArgs> = {}>(
    args?: Prisma.Subset<T, Prisma.Locality$providersArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<
    | runtime.Types.Result.GetResult<
 ...
 * Locality.providers
 */
export type Locality$providersArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
