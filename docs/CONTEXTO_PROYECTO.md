...
- **Graphify 2026-08-12:** regenerado desde worktree limpio y anclado a `597d95c8`: 1,012 archivos, 9,850 nodos, 16,018 relaciones y 478 comunidades (364 mostradas; 114 delgadas omitidas). Extracción 100%; 74 relaciones inferidas con confianza promedio 0.80. `graph.html` no se genera porque supera el límite visual de 5,000 nodos; usar `GRAPH_REPORT.md`, `graph.json` y `graphify query`. El grafo excluye cambios locales sin commit; commits solo documentales/tooling no invalidan su frescura.
