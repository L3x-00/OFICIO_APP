...
**Última actualización:** 2026-07-29 · Estado: PR #53 (`c4c275e`) mergeado en `main`, con CI y despliegues Vercel verdes. El runtime Render queda pendiente de completar su ciclo automático. Subastas, ofertas, referidos/monedas, agenda y cotización continúan OCULTAS de forma reversible; Carta y Catálogo siguen visibles solo para proveedores NEGOCIO.
