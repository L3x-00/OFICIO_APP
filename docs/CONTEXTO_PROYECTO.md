...
**Última actualización:** 2026-08-13 · Estado: **Asistente WhatsApp F1–F4 con OpenWA mergeado a `main`** — PR #69 (squash `0993337`), CI verde y SQL F1/F3/F4 aplicado manualmente. El módulo queda aislado y apagado por feature flags hasta el smoke de salida autorizado; OpenWA conserva sesiones/envío/webhooks genéricos y Servi conserva identidad, política, vínculo y auditoría operativa. Captación de negocios con botón Admin + credenciales (PRs #61/#62) sigue en producción. Subastas, ofertas, referidos/monedas, agenda y cotización continúan OCULTAS de forma reversible; Carta y Catálogo siguen visibles solo para proveedores NEGOCIO.
