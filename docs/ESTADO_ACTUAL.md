# ESTADO ACTUAL — ver CONTEXTO_PROYECTO.md

> El estado vivo y el contexto completo del sistema viven ahora en un único doc
> canónico y portable: **[`docs/CONTEXTO_PROYECTO.md`](CONTEXTO_PROYECTO.md)**
> (§10 = estado / pendientes). Claude lo auto-carga vía `CLAUDE.md`; Codex lo
> lee por instrucción de `AGENTS.md`. Se puede pegar en cualquier chat nuevo.
>
